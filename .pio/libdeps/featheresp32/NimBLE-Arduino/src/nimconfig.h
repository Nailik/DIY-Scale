 ...
 * Parsed value: Skale
 * Raw value: (0x) 53-6B-61-6C-65, "Skale"
 */
#define MYNEWT_VAL_BLE_SVC_GAP_DEVICE_NAME "Skale"
//write flag for name
 ...
 * 0x2A04
 * Properties: READ
 * Parsed value: Connection Interval: 20.00ms - 150.00ms,
 * Slave Latency: 0,
 * Supervision Timeout Multiplier: 3100
 * Raw value: (0x) 10-00-78-00-00-00-1C-0C
 */
#define MYNEWT_VAL_BLE_SVC_GAP_PPCP_MIN_CONN_INTERVAL 16 //results in 20
#define MYNEWT_VAL_BLE_SVC_GAP_PPCP_MAX_CONN_INTERVAL 120 //results in 150
#define MYNEWT_VAL_BLE_SVC_GAP_PPCP_SLAVE_LATENCY 0
#define MYNEWT_VAL_BLE_SVC_GAP_PPCP_SUPERVISION_TMO 3100
